...
export default function B2BIncidentsPage() {
  ...
  const incidents = [
    {
      id: 'INC-2026-0041',
      type: 'AVARIE_MARCHANDISE',
      ref: 'FAC-2026-09450 / Conteneur CSNU4219823',
      subject: 'Avarie constatée à la livraison - Boîtes carton mouillées (50% du lot)',
      date: '22 Août 2026',
      ...
      timeline: [
        { date: '22 Août 14:02', label: 'Déclaration d\'avarie enregistrée', done: true },
        { date: '23 Août 09:15', label: 'Expert désigné (MINEFI-GUCE Expert)', done: true },
        { date: '24 Août 11:30', label: 'Constat d\'avarie contradictoire réalisé', done: true },
        { date: 'En cours', label: 'Rapport d\'expertise en rédaction', done: false },
        { date: 'À venir', label: 'Remboursement assurance TRC ou recours shipper', done: false },
      ],
      messages: [
        { from: 'Votre gestionnaire CADC (Mme Nkeng)', time: '23 Août 10:22', body: 'L\'expert désigné confirmera sa présence demain. Conservez toutes les photos et la marchandise en l\'état.' },
      ]
    },
  ];
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      setShowForm(false);
      toast.success('Déclaration d\'incident enregistrée. Votre gestionnaire vous contactera sous 4h ouvrables.');
    }, 1200);
  };
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Ex: FAC-2026-10892, MSKU7829104, DUM-DLA-2026-8902..."
