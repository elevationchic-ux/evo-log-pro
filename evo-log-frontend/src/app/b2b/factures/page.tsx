...
export default function B2BFacturesPage() {
  const [paymentModal, setPaymentModal] = useState<null | typeof invoices[0]>(null);
  ...
  const invoices = [
    {
      id: 'FAC-2026-10892',
      description: 'Prestation Transit & Douane - Conteneur CMAU9102834 (Kribi PAK)',
      date: '27 Août 2026',
      dueDate: '10 Septembre 2026',
      amount: 3885000,
      currency: 'XAF',
      status: 'EN_ATTENTE',
      items: [
        { label: 'Manutention portuaire (Kribi PAK)', amount: 285000 },
        { label: 'Honoraires CAD & transit', amount: 420000 },
        { label: 'Droits douane payés pour compte client', amount: 1850000 },
        { label: 'Transport DLA → Douala Zone Bassa', amount: 1200000 },
        { label: 'Frais documentaires & BAE', amount: 45000 },
        { label: 'TVA 19.25% sur honoraires', amount: 85000 },
      ],
    },
    {
      id: 'FAC-2026-10710',
      description: "Livraison Corridor N'Djamena - Conteneur MSKU7829104",
      date: '20 Août 2026',
      dueDate: '15 Septembre 2026 (sous 30j livraison)',
      amount: 1200000,
      currency: 'XAF',
      status: 'EN_ATTENTE',
      items: [
        { label: "Transport Douala → N'Djamena (Corridor CEMAC T1)", amount: 980000 },
        { label: 'Escorte sécurisée & balise GPS douane', amount: 150000 },
        { label: 'Frais de dossier transit T1 CEMAC', amount: 70000 },
      ],
    },
    {
      id: 'FAC-2026-09880',
      description: 'Livraison e-POD Yaoundé Cradat - Conteneur HLXU3891025',
      date: '30 Juillet 2026',
      dueDate: 'Payée le 28 Août 2026',
      amount: 2250000,
      currency: 'XAF',
      status: 'PAYEE',
      items: [
        { label: 'Transit import (Reefer pharmaceutique)', amount: 1800000 },
        { label: 'Transport Douala → Yaoundé Cradat', amount: 450000 },
      ],
    },
  ];
  ...
  const handlePay = () => {
    ...
    setTimeout(() => {
      ...
      toast.success(`Paiement de ${paymentModal?.amount.toLocaleString()} XAF initié via ${paymentMethods.find(p => p.id === paymentMethod)?.label}. Vous recevrez une confirmation par SMS.`);
    }, 1500);
  };
