...
const EMPLOYEES_DATA: Employee[] = [
  { id: '1', matricule: 'EMP-001', fullName: 'Oumarou Bouba', department: 'Transport & Logistique', position: 'Chauffeur Poids Lourd Corridor', contractType: 'CDI', entryDate: '15/03/2021', phone: '+237 699 11 22 33', medicalVisitExpiry: '10/11/2026', status: 'ACTIF' },
  { id: '2', matricule: 'EMP-002', fullName: 'Moïse Talla', department: 'Magasin & Stock WMS', position: 'Cariste Senior MAG3', contractType: 'CDI', entryDate: '01/06/2022', phone: '+237 677 44 55 66', medicalVisitExpiry: '05/01/2027', status: 'ACTIF' },
  { id: '3', matricule: 'EMP-003', fullName: 'Marie Essomba', department: 'Direction Financière', position: 'Expert Comptable OHADA', contractType: 'CDI', entryDate: '10/01/2020', phone: '+237 694 77 88 99', medicalVisitExpiry: '12/09/2026', status: 'ACTIF' },
  { id: '4', matricule: 'EMP-004', fullName: 'Samuel Eto', department: 'Opérations Portuaires', position: 'Responsable Quai & Dépotage', contractType: 'CDI', entryDate: '20/08/2019', phone: '+237 655 00 33 22', medicalVisitExpiry: '18/04/2027', status: 'ACTIF' },
  { id: '5', matricule: 'EMP-005', fullName: 'Béatrice Ngo', department: 'Transit & Douane', position: 'Déclarante en Douane SYDONIA', contractType: 'CDD', entryDate: '01/02/2026', phone: '+237 691 33 44 55', medicalVisitExpiry: '15/02/2027', status: 'ACTIF' },
];
