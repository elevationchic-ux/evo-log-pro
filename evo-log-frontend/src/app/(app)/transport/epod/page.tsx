...
export default function EPodPage() {
  ...
  if (!mission) {
    return (
      <div className="min-h-[80vh] bg-slate-800 flex flex-col items-center justify-center p-6 text-center">
        ...
        <h2 className="text-2xl font-black text-slate-200 mb-2">Aucune Mission</h2>
  ...
  return (
    <div className="min-h-screen bg-slate-900 pb-24 font-sans">
      ...
      <div className="px-4 -mt-4 relative z-10 space-y-4">
        ...
        {/* Mission Card */}
        <div className="bg-slate-900 rounded-3xl p-6 shadow-xl shadow-slate-200/50 border border-slate-700">
          ...
          <div className="space-y-6 relative">
            ...
            <div className="relative z-10 flex items-start gap-4">
              <div className="w-6 h-6 rounded-full bg-emerald-500/15 border-4 border-white shadow-sm flex items-center justify-center shrink-0">
            ...
            <div className="relative z-10 flex items-start gap-4">
              <div className="w-6 h-6 rounded-full bg-red-500/15 border-4 border-white shadow-sm flex items-center justify-center shrink-0 mt-1">
        ...
        {/* Quick Actions */}
        <div className="grid grid-cols-2 gap-4">
          <button className="bg-slate-900 flex flex-col items-center justify-center gap-2 p-4 rounded-3xl shadow-sm border border-slate-700 text-slate-400 active:bg-slate-800 transition-colors">
      ...
      {statusUpdated && (
        <div className="fixed inset-0 bg-emerald-500 z-[100] flex flex-col items-center justify-center animate-in fade-in duration-300">
          <div className="w-32 h-32 bg-slate-900 rounded-full flex items-center justify-center mb-6 animate-bounce shadow-2xl">
