...
export default function FinanceOhadaTreasury() {
  ...
  const [prevision, setPrevision] = useState({
    encaissements_prevus: 48500000,
    decaissements_prevus: 29800000,
    solde_prevu: 18700000
  });
    ...
    try {
      ...
      if (res.ok) {
        ...
        if (Array.isArray(data) && data.length > 0) {
          ...
          setAccounts([
            { id: '1', name: 'Afriland First Bank (Compte Principal)', accountNumber: '10005-00124-9847291-32', type: 'BANQUE', balance: 28500000, currency: 'XAF', reconciled: true },
            { id: '2', name: 'Société Générale Cameroun (Opérations Transit)', accountNumber: '10002-00450-4829104-55', type: 'BANQUE', balance: 10000000, currency: 'XAF', reconciled: true },
            { id: '3', name: 'SCB Cameroun (Caution Douane Port)', accountNumber: '10003-00210-5839201-14', type: 'BANQUE', balance: 15000000, currency: 'XAF', reconciled: true },
            { id: '4', name: 'Caisse Principale Siège Douala', accountNumber: 'CAISSE-DLA-01', type: 'CAISSE', balance: 2450000, currency: 'XAF', reconciled: true },
            { id: '5', name: 'Orange Money Entreprise (Frais Route)', accountNumber: '+237 699 00 11 22', type: 'MOBILE_MONEY', balance: 850000, currency: 'XAF', reconciled: true },
            { id: '6', name: 'MTN Mobile Money Business', accountNumber: '+237 677 33 44 55', type: 'MOBILE_MONEY', balance: 650000, currency: 'XAF', reconciled: true },
          ]);
        }
      }
    } catch {
