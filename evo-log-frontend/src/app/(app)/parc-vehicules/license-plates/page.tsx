...
export default function ParcLicensePlatesPage() {
  ...
  const handleCreateRecord = (e: React.FormEvent) => {
    ...
    toast.error('La gestion des immatriculations nécessite encore un endpoint flotte persistant.');
  };
    ...
    <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-outline pb-5">
        ...
        <div className="flex items-center gap-2.5">
          <button
            onClick={() => toast.success('Export du registre des immatriculations au format XLSX généré.')}
