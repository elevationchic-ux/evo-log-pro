  ...
  return (
    <div className="max-w-4xl mx-auto py-8 px-4 text-white animate-in fade-in duration-500">
      <Link href="/magasin/dashboard" className="inline-flex items-center gap-2 text-sm text-slate-400 hover:text-white mb-6">
        <ArrowLeft className="w-4 h-4" /> Retour au Dashboard EVO-Magasin
      </Link>
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-3xl p-8 shadow-2xl space-y-6">
        <div className="flex items-center gap-3 pb-6 border-b border-slate-800">
          ...
          <div>
            <h1 className="text-2xl font-black">Liste des Entrep̫ts & Magasins</h1>
            <p className="text-sm text-slate-400">Cartographie des entrep̫ts portuaires et zones de stockage.</p>
          </div>
        </div>
