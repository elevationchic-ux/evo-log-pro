...
export default function  $args[0].Value.ToUpper() enantDashboard() {
  return (
    <div className="p-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900">🏢 Tenant Multi-locataire</h1>
        <p className="text-gray-600">Système de gestion pour 🏢 Tenant Multi-locataire</p>
      </div>

      <div className="bg-white p-6 rounded-lg shadow border border-gray-200">
        <h2 className="text-lg font-semibold mb-4">Fonctionnalités  $args[0].Value.ToUpper() enant</h2>
