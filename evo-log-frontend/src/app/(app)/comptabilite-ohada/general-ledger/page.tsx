...
export default function ComptabiliteOhadaGeneralLedgerPage() {
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-on-surface">General Ledger</h1>
        ...
        <div className="erp-card-body">
          <div className="text-center py-12">
            ...
            <p className="text-on-surface-variant">
              Comptabilite Ohada - General Ledger
              <br />
