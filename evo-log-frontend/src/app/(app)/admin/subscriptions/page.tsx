  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-slate-100">Gestion des Abonnements</h1>
          <p className="text-slate-400 mt-1">Plans, facturation et revenus SAAS</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-slate-900 p-6 rounded-lg shadow-sm border border-slate-700">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-slate-400">Revenu Mensuel</p>
              <p className="text-2xl font-bold text-slate-100">{(totalRevenue / 1000000).toFixed(1)}M FCFA</p>
            </div>
      ...
      <div className="bg-slate-900 rounded-lg shadow-sm border border-slate-700 p-6">
        <h2 className="text-lg font-semibold text-slate-100 mb-4">Plans d'Abonnement</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {plans?.map((plan: any) => (
            <div key={plan.id} className="border border-slate-700 rounded-lg p-6">
              ...
              <p className="text-3xl font-bold text-blue-600 mb-4">{plan.prix_mensuel.toLocaleString('fr-FR')} FCFA<span className="text-sm text-slate-400">/mois</span></p>
