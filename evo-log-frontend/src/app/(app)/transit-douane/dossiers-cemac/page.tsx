...
const FOLDERS_DATA: TransitFolder[] = [
  { id: '1', folderNumber: 'DOS-CEMAC-2026-041', importer: 'SOTOCO SA (Tchad)', countryDestination: '🇹🇩 Tchad', corridorAxis: 'Douala ➔ Ngaoundéré (Rail) ➔ N\'Djamena (Route)', escortRequired: true, cautionDepositXaf: 45000000, startDate: '20/08/2026', status: 'EN_ROUTE_CEMAC' },
  { id: '2', folderNumber: 'DOS-CEMAC-2026-040', importer: 'MINUSCA Mission ONU', countryDestination: '🇨🇫 RCA', corridorAxis: 'Douala ➔ Yaoundé ➔ Garoua-Boulaï ➔ Bangui', escortRequired: false, cautionDepositXaf: 28000000, startDate: '15/08/2026', status: 'ARRIVE_DESTINATION' },
  { id: '3', folderNumber: 'DOS-CEMAC-2026-039', importer: 'SONASUT (Tchad)', countryDestination: '🇹🇩 Tchad', corridorAxis: 'Douala ➔ Touboro ➔ Moundou', escortRequired: true, cautionDepositXaf: 35000000, startDate: '01/08/2026', status: 'APURE_ARCHIVE' },
];
