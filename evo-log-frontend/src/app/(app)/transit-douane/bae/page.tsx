...
const BAE_DATA: BaeRecord[] = [
  { id: '1', baeNumber: 'BAE-2026-0192', declarant: 'TRANSITLOG SARL', destinataire: 'ESSO Tchad SA', corridor: 'Douala ➔ N\'Djamena (pont N\'Gueli)', marchandise: 'Carburant Avgas & Kérosène', poidsKg: 45000, cautionXaf: 25000000, dateDepart: '20/08/2026', dateEcheance: '20/09/2026', status: 'EN_TRANSIT' },
  { id: '2', baeNumber: 'BAE-2026-0191', declarant: 'AFRICA TRANSIT CO.', destinataire: 'MINUSCA (ONU) Bangui', corridor: 'Douala ➔ Bangui (Garoua-Boulaï)', marchandise: 'Fournitures & Véhicules ONU', poidsKg: 28500, cautionXaf: 18000000, dateDepart: '15/08/2026', dateEcheance: '15/09/2026', status: 'ARRIVE' },
  { id: '3', baeNumber: 'BAE-2026-0188', declarant: 'KAMLOG TRANSIT', destinataire: 'SONASUT Tchad', corridor: 'Douala ➔ N\'Djamena (via Ngaoundéré)', marchandise: 'Sucre Blanc Raffiné 50kg', poidsKg: 60000, cautionXaf: 32000000, dateDepart: '01/08/2026', dateEcheance: '01/09/2026', status: 'APURE' },
];
