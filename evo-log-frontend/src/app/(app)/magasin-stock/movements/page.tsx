...
const MOVEMENTS_DATA: Movement[] = [
  { id: '1', date: '27/08/2026 08:42', sku: 'ART-LUB-001', designation: 'Huile Moteur 15W40 Fût 200L', type: 'ENTREE', qtyMoved: 40, fromLocation: 'Quai Réception', toLocation: 'MAG3-B-04-N2', reference: 'BL-2026-0881', operator: 'Moïse Talla' },
  { id: '2', date: '27/08/2026 10:15', sku: 'ART-PNEU-225', designation: 'Pneu PL 315/80 R22.5 Michelin', type: 'SORTIE', qtyMoved: 8, fromLocation: 'MAG3-D-01-Sol', toLocation: 'Quai Expédition 2', reference: 'PC-2026-0412', operator: 'Samuel Eto' },
  { id: '3', date: '26/08/2026 15:30', sku: 'ART-FLT-OIL', designation: 'Filtre à Huile Actros', type: 'TRANSFERT', qtyMoved: 20, fromLocation: 'MAG3-A-02-N1', toLocation: 'MAG3-A-03-N1', reference: 'TR-2026-0045', operator: 'Moïse Talla' },
  { id: '4', date: '25/08/2026 09:00', sku: 'ART-PNEU-225', designation: 'Pneu PL 315/80 R22.5 Michelin', type: 'REGULARISATION', qtyMoved: -2, fromLocation: 'MAG3-D-01-Sol', toLocation: '-', reference: 'INV-2026-0012', operator: 'Responsable Magasin' },
];
