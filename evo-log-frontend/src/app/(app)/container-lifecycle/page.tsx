...
export default function  $args[0].Value.ToUpper() ontainer lifecycleDashboard() {
  return (
    <div className="p-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900">📦 Cycle Conteneurs</h1>
        <p className="text-gray-600">Système de gestion pour 📦 Cycle Conteneurs</p>
      </div>

      <div className="bg-white p-6 rounded-lg shadow border border-gray-200">
        <h2 className="text-lg font-semibold mb-4">Fonctionnalités  $args[0].Value.ToUpper() ontainer lifecycle</h2>
