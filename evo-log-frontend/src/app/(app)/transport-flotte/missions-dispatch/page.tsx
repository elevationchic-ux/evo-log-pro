...
const MISSIONS: Mission[] = [
  { id: '1', code: 'TR-2026-0941', corridor: 'Douala Port ➔ N\'Djamena (Tchad)', client: 'TOTAL Cameroun / Tchad S.A.', driver: 'Oumarou Bouba', truckPlate: 'LT-849-EF', trailerPlate: 'REM-304-DLA', cargo: 'Conteneur 40ft Lubrifiants (MSCU8492019)', departureDate: '27/08/2026', status: 'EN_ROUTE', progress: 45 },
  { id: '2', code: 'TR-2026-0940', corridor: 'Douala Port ➔ Bangui (RCA)', client: 'Centrafrique Mining Transit', driver: 'Jean-Pierre Ndongo', truckPlate: 'LT-112-AA', trailerPlate: 'REM-118-DLA', cargo: 'Conteneur 20ft Matériel Forage', departureDate: '26/08/2026', status: 'EN_ROUTE', progress: 70 },
  { id: '3', code: 'TR-2026-0939', corridor: 'Douala ➔ Yaoundé (Zone Industrielle)', client: 'SABC Boissons', driver: 'Eric Fotso', truckPlate: 'CE-450-GH', trailerPlate: 'REM-501-YDE', cargo: 'Matières premières brassage', departureDate: '27/08/2026', status: 'LIVRE', progress: 100 },
  { id: '4', code: 'TR-2026-0938', corridor: 'Douala Port ➔ Garoua', client: 'SODECOTON', driver: 'Aliou Mohamadou', truckPlate: 'LT-992-ZZ', trailerPlate: 'REM-220-DLA', cargo: 'Engrais & Intrants cotonniers', departureDate: '28/08/2026', status: 'AFFECTE', progress: 0 },
];
