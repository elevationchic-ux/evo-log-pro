...
const FLEET_DATA: Vehicle[] = [
  { id: '1', immatriculation: 'LT-849-EF', type: 'TRACTEUR', brandModel: 'Mercedes Actros 3340 (6x4)', year: 2022, odometer: 184500, technicalInspectionDate: '15/11/2026', insuranceDate: '31/12/2026', tcoMonthly: 1250000, status: 'OPERATIONNEL' },
  { id: '2', immatriculation: 'LT-112-AA', type: 'TRACTEUR', brandModel: 'Volvo FH16 540 Globetrotter', year: 2023, odometer: 120800, technicalInspectionDate: '20/10/2026', insuranceDate: '31/12/2026', tcoMonthly: 1400000, status: 'OPERATIONNEL' },
  { id: '3', immatriculation: 'REM-304-DLA', type: 'SEMI_REMORQUE', brandModel: 'Plateau 3 Essieux Porte-Conteneurs 40ft', year: 2021, odometer: 210000, technicalInspectionDate: '05/09/2026', insuranceDate: '31/12/2026', tcoMonthly: 350000, status: 'OPERATIONNEL' },
  { id: '4', immatriculation: 'LT-992-ZZ', type: 'TRACTEUR', brandModel: 'Renault Kerax 440 DXi', year: 2020, odometer: 340200, technicalInspectionDate: '12/08/2026', insuranceDate: '31/12/2026', tcoMonthly: 1850000, status: 'EN_MAINTENANCE' },
];
