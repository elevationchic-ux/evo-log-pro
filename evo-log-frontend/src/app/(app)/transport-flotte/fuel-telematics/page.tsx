...
const FUEL_DATA: FuelRecord[] = [
  { id: '1', immatriculation: 'LT-849-EF', driver: 'Oumarou Bouba', tankCapacity: 600, currentLevel: 420, consumptionAvg: 34.2, lastRefuelLitres: 400, lastRefuelDate: '27/08/2026 06:15', anomaliesDetected: false, status: 'NORMAL' },
  { id: '2', immatriculation: 'LT-112-AA', driver: 'Jean-Pierre Ndongo', tankCapacity: 700, currentLevel: 510, consumptionAvg: 36.8, lastRefuelLitres: 500, lastRefuelDate: '26/08/2026 18:30', anomaliesDetected: false, status: 'NORMAL' },
  { id: '3', immatriculation: 'LT-992-ZZ', driver: 'Aliou Mohamadou', tankCapacity: 600, currentLevel: 80, consumptionAvg: 48.5, lastRefuelLitres: 350, lastRefuelDate: '25/08/2026 14:00', anomaliesDetected: true, status: 'ALERTE_SIPHONNAGE' },
];
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <div className="bg-slate-900/80 border border-slate-800 p-5 rounded-2xl">
          ...
          <div className="text-2xl font-black text-slate-100 font-mono">
            35.5 <span className="text-xs text-slate-400 font-normal">L / 100 km</span>
          </div>
        ...
        <div className="bg-slate-900/80 border border-slate-800 p-5 rounded-2xl">
          ...
          <div className="text-2xl font-black text-blue-400 font-mono">
            28,400 <span className="text-xs font-normal">Litres</span>
          </div>
        ...
        <div className="bg-slate-900/80 border border-slate-800 p-5 rounded-2xl">
          ...
          <div className="text-2xl font-black text-red-400 font-mono">
            1 <span className="text-xs font-normal text-slate-400">incident</span>
          </div>
          <div className="text-[11px] text-red-300/80 mt-2 flex items-center gap-1">
            <AlertTriangle className="w-3.5 h-3.5" /> Camion LT-992-ZZ (Chute de 120L à l arrêt)
          </div>
        </div>
      </div>
