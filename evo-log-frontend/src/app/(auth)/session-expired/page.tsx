  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-900 relative">
      ...
      <div className="relative z-10 w-full max-w-[420px] mx-4">
        ...
        <div className="bg-slate-900/95 dark:bg-slate-800/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20 dark:border-white/10 p-7 text-center">
          <div className="flex justify-center mb-4">
            <div className="w-16 h-16 rounded-full bg-amber-500/15 dark:bg-amber-900/30 flex items-center justify-center">
          ...
          <h2 className="text-lg font-bold text-slate-200 dark:text-slate-100 mb-2">{t.auth.sessionExpiredTitle}</h2>
          <p className="text-sm text-slate-500 dark:text-slate-400 mb-4">{t.auth.sessionExpiredBody}</p>
          <div className="flex items-start gap-2 p-3 bg-slate-800 dark:bg-slate-700/50 border border-slate-700 dark:border-slate-600 rounded-lg mb-6 text-left">
          ...
          <div className="mt-5 pt-4 border-t border-slate-700 dark:border-slate-700 flex items-center justify-center gap-2 text-slate-400">
